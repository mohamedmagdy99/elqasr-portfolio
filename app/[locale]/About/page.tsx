    ...
    return (
      <Transition>
        ...
        <div
          ...
          dir={isRtl ? "rtl" : "ltr"}
        >
          <section className="bg-linear-to-br from-blue-50 to-indigo-100">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              >
                ...
                >
                  ...
                  >
                    <motion.p variants={fadeInUp}>{t("our_story_p1")}</motion.p>
                    <motion.p variants={fadeInUp}>{t("our_story_p2")}</motion.p>
                    <motion.p variants={fadeInUp}>{t("our_story_p3")}</motion.p>
                  </motion.div>
                </motion.div>
                <motion.div
                  initial="initial"
          ...
          <section className="py-16">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              >
                ...
                <p className="text-xl text-gray-600 mb-8 max-x-2xl mx-auto">
                  {t("cta_description")}
                </p>
                <div className="flex sm:flex-row flex-col gap-4 justify-center">
                  ...
                  >
                    <Link href="/Projects">{t("cta_projects_button")}</Link>
                  </Button>
                </div>
              </motion.div>
            </div>
